...
function AboutMe() {
  return (
    <section id="about-me" className="about-me">
      <h2 className="about-me__title about-me__title_page-up">Студент</h2>
      <div className="about-me__info">
        <div className="about-me__about">
          <h3 className="about-me__title about-me__title_name">Мария</h3>
          <h4 className="about-me__text about-me__text_prof">Студентка, 36 лет</h4>
          <p className="about-me__text about-me__text_about">
          ...
          <p className="about-me__text about-me__text_github">Github</p>
        </div>
